 ...
 */
export async function reqInstagramPostGetList(
  start: number,
): Promise<ResponseAiqnaAPI<ResponseDBSelect<TSqlInstagramPostList[]>>> {
 ...
 */
export async function reqInstagramPostRegister(
  data: TSqlInstagramPostDetailInsert,
): Promise<ResponseAiqnaAPI<ResponseDBSelect<TSqlInstagramPostDetail[]>>> {
 ...
 */
export async function reqInstagramPostGetDetail(
  uuid36: string,
): Promise<ResponseAiqnaAPI<ResponseDBSelect<TSqlInstagramPostDetail[]>>> {
 ...
 * @returns ResponseAiqnaAPI<ResponseDBSelect<TSqlInstagramPostDetail[]>>
 */
export async function reqInstagramPostDelete(
  uuid36: string,
): Promise<ResponseAiqnaAPI<ResponseDBSelect<TSqlInstagramPostDetail[]>>> {
 ...
 * @returns ResponseAiqnaAPI<ResponseDBSelect<TSqlInstagramPostDetail[]>>
 */
export async function reqInstagramPostUpdate(
  uuid36: string,
  data: TSqlInstagramPostDetailUpdate,
): Promise<ResponseAiqnaAPI<ResponseDBSelect<TSqlInstagramPostDetail[]>>> {
