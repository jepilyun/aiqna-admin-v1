 ...
 */
export async function reqBlogPostGetList(
  start: number,
): Promise<ResponseAiqnaAPI<ResponseDBSelect<TSqlBlogPostList[]>>> {
 ...
 */
export async function reqBlogPostRegister(
  data: TSqlBlogPostDetailInsert,
): Promise<ResponseAiqnaAPI<ResponseDBSelect<TSqlBlogPostDetail[]>>> {
 ...
 */
export async function reqBlogPostGetDetail(
  uuid36: string,
): Promise<ResponseAiqnaAPI<ResponseDBSelect<TSqlBlogPostDetail[]>>> {
 ...
 * @returns ResponseAiqnaAPI<ResponseDBSelect<TSqlBlogPostDetail[]>>
 */
export async function reqBlogPostDelete(
  uuid36: string,
): Promise<ResponseAiqnaAPI<ResponseDBSelect<TSqlBlogPostDetail[]>>> {
 ...
 * @returns ResponseAiqnaAPI<ResponseDBSelect<TSqlBlogPostDetail[]>>
 */
export async function reqBlogPostUpdate(
  uuid36: string,
  data: TSqlBlogPostDetailUpdate,
): Promise<ResponseAiqnaAPI<ResponseDBSelect<TSqlBlogPostDetail[]>>> {
